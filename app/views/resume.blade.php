...
<div class="content"> 
    ...
    <div class="contact">
        ...
        <p>
            <i class="fa fa-envelope-o fa-2x"></i><!-- fa-spin -->
            Jbns89@gmail.com
        </p>
        <p>
            <i class="fa fa-github-alt fa-2x"></i><!--fa-spin-->
            <a href="https://github.com/Jbns89" class="btn btn-default btn-xs active" role="button">GitHub</a>
        </p>
        <p>
            <i class="fa fa-twitter-square fa-2x"></i><!-- fa-spin -->
